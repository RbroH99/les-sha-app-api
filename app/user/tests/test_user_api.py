...
class PublicUserApiTests(TestCase):
    ...
    def test_create_user_valid_phone_number_success(self):
        """Test creating a user with a valid phone number is succesful."""
        payload = {
            'email': 'test@example.com',
            'password': 'pass123',
            'name': 'Test Name',
    ...
    def test_create_user_invalid_phone_number_error(self):
        """Test creating a user with an invalid phone results in error."""
        payload = {
            'email': 'test@example.com',
            'password': 'pass123',
            'phone': '+53591',
